...
gem_templates = [
    ...
    dir + "\\jacob_img\\floating_70m_range.png",
    dir + "\\jacob_img\\floating_70m_left.png",
...
def click_gems():
    ...
    success, x, y = match_template(dir + "\\jacob_img\\5g_claim.png")
    if success: 
...
def main():
    ...
    try:
        ...
        while True:
            ...
            if health_iter > random.randint(10, 30):
                click_health()
                health_iter = 0
